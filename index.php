    ...
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            <div class="image">
              <a href="WhatsApp Image 2024-08-28 à 16.21.46_156588af.jpg"><img src="WhatsApp Image 2024-08-28 à 16.21.46_156588af.jpg" alt="" /></a>
            </div>
            <div class="author-content">
              <h4>Ogou jean</h4>
              <span>developpeur web(laravel)</span>
            </div>
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                <li><a href="#section1">A propos</a></li>
                <li><a href="#section2">Mes competences</a></li>
                <li><a href="#section3">Mes realisatons</a></li>
                <li><a href="#section4">contact moi</a></li>
              </ul>
            </nav>
      ...
      <section class="section about-me" data-section="section1">
        <div class="container">
          <div class="section-heading">
            ...
            <span
              >Hello moi c'est jean j'ai 20ans,tu peux m'appeler micky si tu veux,suis passionner de la musique et 
              j'en fais beaucoupe si t'est la  t'aura l'occasion de vois mes realisations a l'avenir.Apres mon bac
              j'ai continuer mes etudes dans le code(creation de site web) et je me suis specialiser en laravel.consulte la pages mes 
              realisations si tu veux voir ce que j'ai pu faire dans ce domaine.</span
            >
          </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="right-content">
        <div class="container">
          <form id="contact" action="https://formspree.io/f/xkgwagpb" method="post">
            <div class="row">
              <div class="col-md-6">
                <fieldset>
                  <input
